...
interface EnvironmentTableToolbarProps<TData> {
  table: Table<TData>;
  flocks: Array<{ id: string; batchCode: string; currentCount: number }>;
}

export function EnvironmentTableToolbar<TData>({
  table,
  flocks,
}: EnvironmentTableToolbarProps<TData>) {
            ...
            <PopoverTrigger asChild>
              ...
              >
                {selectedMonth ? (
                  ...
                  <span>{t('table.filterByMonth')}</span>
                )}
            ...
            <PopoverTrigger asChild>
              ...
              >
                {selectedDate ? (
                  ...
                  <span>{t('table.filterByDate')}</span>
                )}
                <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
              </Button>
            </PopoverTrigger>

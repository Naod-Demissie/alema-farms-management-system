...
export default function StaffManagementPage() {
  ...
  const recentActivity = [
    { id: 1, action: "John Doe checked in", time: "2 minutes ago", type: "attendance" },
    { id: 2, action: "Jane Smith submitted leave request", time: "15 minutes ago", type: "leave" },
    { id: 3, action: "Mike Johnson completed onboarding", time: "1 hour ago", type: "onboarding" },
    { id: 4, action: "Sarah Wilson's payroll processed", time: "2 hours ago", type: "payroll" },
  ];
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {overviewStats.totalStaff - overviewStats.activeStaff} inactive
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{overviewStats.attendanceRate}%</div>
                  <p className="text-xs text-muted-foreground">
                    +2.1% from last month
                  </p>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{overviewStats.pendingLeaves}</div>
                  <p className="text-xs text-muted-foreground">
                    Requires approval
                  </p>
                </CardContent>
